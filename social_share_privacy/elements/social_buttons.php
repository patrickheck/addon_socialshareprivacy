...
<script type="text/javascript">
  ...
  services : {
    facebook : {
	  ...
	  'dummy_img' : '<?php  echo $sh->getServiceImage("facebook") ?>' ,
    ...
    twitter : {
		...
		'dummy_img' : '<?php  echo $sh->getServiceImage("twitter") ?>',
    ...
    gplus : {
	  ...
	  'dummy_img' : '<?php  echo $sh->getServiceImage("gplus") ?>',
  ...
  'info_link' : '<?php   echo t("http://www.heise.de/ct/artikel/2-Klicks-fuer-mehr-Datenschutz-1333879.html")?>',
